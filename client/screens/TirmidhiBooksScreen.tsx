...
import indexData from "@/data/the_9_books/tirmidhi/index.json";
...
export default function TirmidhiBooksScreen() {
  ...
  const books = (indexData as TirmidhiData).books ?? [];
  ...
  const title = (indexData as TirmidhiData).titleAr;
            ...
            {filteredBooks.map((item, index) => {
              ...
              return (
                <View key={item.id}>
                  <Pressable
                    onPress={() =>
                      navigation.navigate("TirmidhiChapter", { chapterId: item.id })
                    }
                    style={[
                      styles.rowOuter,
