...
import chapters from "@/data/the_9_books/tirmidhi/chapters";
...
type RouteProps = {
  key: string;
  name: "TirmidhiChapter";
  params: LibraryStackParamList["TirmidhiChapter"];
};
...
export default function TirmidhiChapterScreen() {
